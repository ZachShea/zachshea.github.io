...
function ProductMaker() {
  return (<div>
      ...
      Shortly after starting classes at the University of Central Florida, I began cofounding a startup called <ExternalLink text="Zuke Music" url="https://zukemusic.com"/>. For almost a year, I helped to conduct customer interviews, determine product-market fit, and design mockups and interactive prototypes for the app. We continued to iterate as we conducted user studies and developed our business model. I began writing the code for the iOS app, and Zuke launched March 2017.<br/><br/>
